    ...
    <div class="py-16">
        <div class="mx-auto px-6 max-w-6xl text-gray-500">
            <div class="text-center">
                <h2 class="text-3xl text-gray-950 dark:text-black font-semibold">Quickstart with boilerplates</h2>
                <p class="mt-6 text-gray-700 dark:text-black">Harum quae dolore inventore repudiandae? orrupti aut temporibus ariatur.</p>
            </div>
